          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex items-center shrink-0">
                <Link href="/" className="flex items-center text-gray-800">
                  {/* simple text/logo in place of ApplicationLogo */}
                  <svg
                    className="mr-2 text-gray-800 w-9 h-9"
                  ...
                  <span className="font-semibold">Tardetect</span>
                </Link>
              </div>
            ...
            <div className="hidden sm:flex sm:items-center sm:ms-6">
              <div className="relative ms-3">
                ...
                {showUserDropdown && (
                  <div className="absolute right-0 z-10 w-48 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg focus:outline-none">
                    <div className="py-1">
                      <Link
